...
@Component({
  selector: 'app-update-planned-duty',
  standalone: true,
  imports: [CommonModule,ReactiveFormsModule,FormsModule],
  templateUrl: './update-planned-duty.component.html',
  styleUrl: './update-planned-duty.component.css'
})
export class UpdatePlannedDutyComponent {
  blocks: Block[];
    branchs: Branch[];
    duty: PlannedDuty;
    block: Block
    ...
    updateDutyItem:string= "POST.Updating.PlannedUpdateDutyItem"
  
    @Output() dutyUpdateEvent = new EventEmitter<any>()
    ...
    constructor(private dutyComponentService: PlannedDutyComponentService, 
    ...
    updateDuty() {
      ...
      this.dutyComponentService.updatePlannedDuty(model, () => {
        this.dutyUpdateEvent.emit(true)
      })
    }
